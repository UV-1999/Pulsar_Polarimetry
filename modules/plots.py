...
def plot_polarisation_parameters(data, start_phase, end_phase, on_pulse, obs_id):
    ...
    ax1.scatter(phase_axis, p_frac, label="P/I", color='tab:blue')
    ax1.scatter(phase_axis, l_frac, label="L/I", color='tab:orange')
    ax1.scatter(phase_axis, v_frac, label="V/I", color='tab:green')
    ...
    ax2.scatter(phase_axis, PA, color='tab:red')
    ...
    ax5.scatter(phase_axis[on_pulse_mask], dPA_dphi[on_pulse_mask], color='tab:blue')
    ax5.set_ylabel("Normalised PA Derivative")
    ax5.set_xlim(start_phase, end_phase)
    ax5.grid(True)
    ax5.set_xlabel("Pulse Phase")

    ax3.scatter(phase_axis, EA, color='tab:purple')
...
def plot_single_pulse_stokes(data, start_phase, end_phase, on_pulse, pulse_index, obs_id):
    ...
    axs[1].scatter(phase_axis, dPA_dphi, label="dPA", color='tab:red')
    axs[1].scatter(phase_axis, p_frac, label="P/I", color='tab:blue')
    axs[1].scatter(phase_axis, l_frac, label="L/I", color='tab:orange')
    axs[1].scatter(phase_axis, v_frac, label="V/I", color='tab:green')
